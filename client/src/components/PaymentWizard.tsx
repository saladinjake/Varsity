          ...
          <AnimatePresence mode="wait">
            {step === 'method' && (
              ...
              >
                ...
                >
                  Switch to Terminal Simulation Mode
                </button>
              </motion.div>
            )}
            ...
            {step === 'simulated' && (
              ...
              >
                ...
                <h4 className="text-2xl font-black text-slate-900">Virtual Terminal Ready</h4>
            ...
            {step === 'success' && (
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-slate-500 text-sm mt-2">Redirecting to your course terminal...</p>
                </div>
              </motion.div>
            )}
