    ...
    <div className="max-w-6xl mx-auto flex flex-col gap-12 pt-10 px-8">
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-10">
            ...
            <div className="flex flex-col gap-6">
                 <h3 className="text-xs font-black uppercase tracking-widest text-slate-400">Terminal History</h3>
                 {[1, 2].map((i) => (
        ...
        <footer className="glass-card p-10 bg-slate-900 border-none shadow-2xl flex items-center justify-between overflow-hidden relative">
            <div className="flex flex-col gap-2 z-10">
                ...
                <p className="text-slate-400 text-sm font-medium">Verify your skills via the industrial assessment terminal to gain verified status.</p>
            </div>
