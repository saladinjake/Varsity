...
export default function CourseDetails() {
  ...
  const handleEnroll = () => {
    ...
    if (course.is_enrolled) {
      toast.success("Active session detected! Initializing terminal...", {
        icon: '',
  ...
  if (isLoading) return <div className="max-w-7xl mx-auto px-6 py-20 text-center text-slate-500 font-bold">Initializing Varsity Terminal...</div>;
          ...
          <div className="glass-card p-10 flex flex-col gap-8 bg-slate-900 text-white border-none shadow-2xl">
            ...
            {course.is_enrolled ? (
              ...
              <div className="flex flex-col gap-4">
                ...
                >
                  {enrollmentMutation.isPending ? "Transmitting..." : "Initialize Enrollment"}
                  <ArrowRight size={20} />
                </button>
