...
export default function CourseNavigation() {
  ...
  if (isLoading) return <div className="p-20 text-center font-black text-slate-400">Loading Terminal Assets...</div>;
        ...
        <header className="h-20 border-b border-slate-100 flex items-center justify-between px-8 bg-white z-20 shrink-0 shadow-sm">
            <div className="flex items-center gap-6">
                ...
                <div className="flex flex-col overflow-hidden">
                    ...
                    <span className="text-[10px] font-bold text-sky-600 uppercase tracking-[3px]">Academic Terminal / Professional Edition</span>
                </div>
            </div>
            ...
            <main className="flex-1 flex flex-col h-full bg-white overflow-y-auto relative">
                {currentLesson ? (
                    ...
                    <div className="flex-1 flex flex-col items-center justify-center gap-6 text-slate-400">
                        ...
                        <span className="font-black text-xs uppercase tracking-[4px]">Synchronizing Terminal...</span>
                    </div>
                )}
            </main>
        </div>
